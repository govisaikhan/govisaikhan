...
const I18N = {
  mn: {
    ...
    badge_exec:"ОНӨААТҮГ-ын Дарга",
    hero_title:"Нийслэлийн хөрөнгө оруулалтын газрын дарга <span class='grad'>М.Говьсайхан</span>",
    hero_desc:"Хүрээлэн буй орчинд ээлтэй чанарыг эрхэмлэсэн бүтээн байгуулалтыг цогцлооно.",
    ...
    bio_title:"Нийгэмд хийж хэрэгжүүлсэн төсөл хөтөлбөр", bio_name:"М.Говьсайхан", bio_role:"ОНӨААТҮГ-ын Дарга",
